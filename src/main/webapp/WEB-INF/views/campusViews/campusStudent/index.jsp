	...
	<div id="aside_container">
		...
		<aside id="left_push_aside" data-position="left"
			...
			<ul class="menu">
				...
				<li class="side-list"><a href="MyApplication.do"data-toggle="html">
				...
				<li class="side-list"
					onclick="window.open('<%=path%>/campusStudent/InManage.do?type=qingjia')">
					<a class="menu active">
						<div class="side-list-round">
				...
				<li class="side-list"
					onclick="window.open('<%=path%>/campusStudent/InManage.do?type=zhaochao')">
					<a class="menu active">
						<div class="side-list-round">
				...
				<li class="side-list"
					onclick="window.open('<%=path%>/campusStudent/InManage.do?type=zixi')">
					<a class="menu active">
						<div class="side-list-round">
							<img src="<%=path%>/AgileLite/assets/app/img/about/personage.png"
								class="wmz-side-img" />
		...
		<section id="aside_section" data-role="section" class="active"
			...
			<article data-role="article" id="main_article" class="active"
				...
				<div class="scroller">
					...
					<ul class="listitem">
						<li class="sliver">学院通知
						<li><span class="icon"> <i
								class="iconfont iconline-radio-fill unread"></i> <br /> <i
								class="iconfont iconline-attach"></i> </span> <i
							class="ricon iconfont iconline-arrow-right"></i>
							<div class="text">
								实践教学重要通知<i class="right iconfont iconline-fav"></i> <small>电子信息学院<font
									class="right">2015年11月11日</font>
								</small>
							</div></li>
						<li><span class="icon"> <i
								class="iconfont iconline-radio-fill unread"></i> <br /> <i
