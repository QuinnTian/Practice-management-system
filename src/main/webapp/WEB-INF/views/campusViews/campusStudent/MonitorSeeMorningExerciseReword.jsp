...
<script type="text/javascript">
	function ajaxGetDailyIns() {
		...
		$.ajax({
			...
			url : "CampusStudent/web/ajaxGetDailyIns.do?",
	...
	function showPractice(ajaxData){
		...
		$("table[id='stuTable'] tr[id!='tableHead']").remove();
		$("#tableHead").after(ajaxData);
	}
	function getSendData() {
			var begin_Time = $("#begin_Time").val();
			var leibie=$("#leibie").val();
			var dataSend = "begin_Time=" + begin_Time+"&leibie="+leibie;			
			return dataSend;
		}
</script>
...
<body>
	...
	<table id="stuTable" border="1" width="1300" class="sjjx-table" cellspacing="0" cellpadding="0">
			<tr id="tableHead">
				<th width="100">班级：</th>
				<th width="100">分数：</th>
