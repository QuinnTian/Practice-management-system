...
<script type="text/javascript">
	...
	function getTitle(){
		...
		var teaName=$("#teaName").val();
	   	var title = "指导记录" + "-" + year+"年"+month+"月" + "-" + teaName ;
		$("#title").val(title);
	}
...
<body>
	<h2 align="left">教师记录上传</h2>
	<input type="hidden" value="${tea.true_name}" id="teaName" name="teaName" />
	<form name="form1" id="form" method="post" action="doAdddirectrecord.do"
			...
			<tr>
				<td width="100">描述：</td>
					...
					<div class="wordCount" id="wordCount">
					      <textarea name="content" rows="7"  style="width:100%;height:100%;"
					       id="content"></textarea>
