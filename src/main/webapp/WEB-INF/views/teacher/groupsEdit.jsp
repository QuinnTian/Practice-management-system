...
<body>
	<form name="Form2" action="doEditGroups.do" method="post">
		<input type="hidden" name="id" value="${groups.id}">
		<h2>查看分组信息</h2>
		<table border="1" width="1000" bgcolor="#F0F0F0">
			<tr>
				<td width="150">分组名称：</td>
				<td width="270"><input type="text" name="group_name"
					id="group_name" style="width:900px;height:50px; border: 0;"
					disabled="true " value="${groups.group_name}">
				</td>
			</tr>
			<tr>
				<td width="150">分组目的：</td>
				<td width="270"><input type="text" name="purpose"
					style="width:900px;height:50px;  border: 0;"
					value="${groups.purpose}">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="900"><textarea name="description"
						style="width:900px; height: 100;  border: 0;">${groups.description}</textarea>
				</td>
			</tr>
		</table>
		<div style="margin-top:20px;">
			<button type="button" onclick="window.location.href ='groupsList.do'">返回</button>
