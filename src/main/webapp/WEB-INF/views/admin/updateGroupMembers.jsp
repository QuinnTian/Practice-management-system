...
<script type="text/javascript">
		...
		if (teas.length > 0) {
			for (i = 0; i < teas.length; i++) {
				...
				if (isInArray(cd, jb)) {
					...
					nextRow.insertCell().innerHTML = "<input type='checkbox' id='teas[i].id' onclick='showcount()' name='ck' value="+biaoShi+"+"+"> ";
					nextRow.insertCell().innerHTML = teas[i].true_name;
			...
			for (i = 0; i < stus.length; i++) {
				...
				if (isInArray(cd, jb)) {
					...
					if (group_id == null) {
						groupName = "暂无分组";
						var nextRow = stuTab.insertRow(stuTab.rows.length);
						nextRow.insertCell().innerHTML = "<input type='checkbox' id='stus[i].id' onclick='showcount()' name='ck' value="+biaoShi+"+"+groupName+ "> ";
						nextRow.insertCell().innerHTML = stus[i].true_name;
						nextRow.insertCell().innerHTML = "<span id='span'>("
								+ groupName + ")</span>";
					} else if (group_id == "无") {
						groupName = "暂无分组";
						var nextRow = stuTab.insertRow(stuTab.rows.length);
						...
						groupName = group_id + "小组";
						var nextRow = stuTab.insertRow(stuTab.rows.length);
						nextRow.insertCell().innerHTML = "<input type='checkbox' id='stus[i].id' onclick='showcount()' name='ck' value="+biaoShi+"+"+groupName+"> ";
						nextRow.insertCell().innerHTML = stus[i].true_name;
						nextRow.insertCell().innerHTML = "<span id='span'>(<font color='red'>"
								+ groupName + "</font>)</span>";
					}
				}
			}
	...
	function addGroupMember() {
		$('#div1 input[name="ck"]:checked').each(function() {
			var str = $('input[name="ck"]:checked:first').val();
			console.log("strstr+++:" + str);
			var s = str.indexOf("+");
			var c = str.indexOf("-");
			var or_le = str.substring(0, c);
			var gN = str.substring(s + 1, str.length);
			console.log("gN+++:" + gN);
			if (gN == "暂无分组" || gN == "") {
				$(this).parent().parent().appendTo("#div2");
				return;
			} else {
				alert("该学生已在" + gN + "！若要更改分组，请从" + gN + "中删除该成员！");
			}
		});
...
<body>
	...
	<form name="Form2" action="updateGroups.do" method="post">
		...
		<div id="div8">
			<b>成员查询：</b> 成员类型： <select id="jiaoSe" name="jiaose"
				onChange="changeJS()" style="width:100px">
				<option>请选择</option>
		...
		<div id="div4">
			...
			<div >
				已选人数：<span id="yxrs"></span>
			</div>

		</div>
		<div id="div6">
			<br> <br> <br> <br> <br> <br> <input
				type="button" value=">>添加" onclick="addGroupMember();showcount2();showcount()" /> <br /> <br />
			<br /> <br /> <br /> <br /> <input type="button" onclick="dele();showcount();showcount2()" 
				value="<<移出" />
		</div>
		<div id="div3">
			<h3>组内成员</h3>
			...
			<div id="div2">
				...
				<%
		 				...
		 				%> 	 --%> <input type='checkbox' onclick="showcount2()" id="${g.user_id}" name='ck'
								value="${g.user_id}"> <input type="hidden"
								name='group_id' value="${g.group_id}"> <%
 	String user_id = (String) request.getAttribute("user_id");
 		if (user_id.length() > 16) {
 ...
 %></td>
			...
			<div>已选人数：<span id="yxrs2"></span></div>
		</div>
		...
		<div id="div9">
			<p>
				<button type="button" onclick="selectAll()">全选未分组的成员</button>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
