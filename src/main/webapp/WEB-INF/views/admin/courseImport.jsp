...
<body>
	...
	<input type="hidden" id="type" name="type" value="excelCourse">
		<div style="float:left">
			<table border="1" width="600">
				<tr>
					<td width="150"><input type="hidden" name="_method"
						value="post"> 课程信息文件(*.xls): <input type="file"
			...
			<table border="1" width="200">
				<tr>
					...
					<td><button type="button"
							onClick="window.location='courseList.do'">返回</button></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<table border="1" width="1300" id="table1">
		<tr>
			...
			<td width="60" align="center"><b>开设组织</b></td>
			<td width="120" align="center"><b>授课对象</b></td>
			<td width="300" align="center"><b>数据表数据问题</b></td>
		</tr>
		<c:forEach var="s" items="${newcoursesList}" varStatus="stauts">
			<tr>
				<td align="center">${s.course_code}</td>
				<td align="center">${s.course_name}</td>
				<td align="center">${s.org_name}</td>
				<td align="center">${s.class_object}</td>
