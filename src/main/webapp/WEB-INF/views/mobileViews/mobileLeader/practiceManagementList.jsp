					...
					<ul class="listitem">
						...
						<li><i class="icon iconfont iconline-fav"></i>
							<div class="text" href="InternshipStudentList.do" data-toggle="html">
								实习状态统计</div></li>
						<li><i class="icon iconfont iconline-fav"></i>
							<div class="text" href="schoolBmapPie.do"
								data-toggle="html">学校签到统计</div></li>
						<li href="getCollegeStudentCityStatistics.do" data-toggle="html"><i
							class="icon iconfont iconline-fav"></i>
							<div class="text">学校实习地点分布</div></li>
						
						<li href="signUse.do" data-toggle="html"><i
							class="icon iconfont iconline-fav"></i>
							<div class="text">学校同级地点分布</div></li>
					</ul>
				</div>
			</article>
