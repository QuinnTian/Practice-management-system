			...
			<header>
				<div class="titlebar">
					<a data-toggle="back" href="#"><i
						class="iconfont iconline-arrow-left"></i> </a> s
					<h1>个人信息</h1>
				</div>
			</header>
			<article data-role="article" id="practice_article"
				...
				<div class="scroller">
					<ul class="listitem">
						...
						<li href="PersonalInformationMaintenance.do" data-toggle="html">
							<i class="icon iconfont iconline-fav"></i>
							<div class="text">信息维护</div>
						</li>
						<li href="ChangePassword.do" data-toggle="html"><i
							class="icon iconfont iconline-fav"></i>
							<div class="text">修改密码</div></li>
					</ul>
				</div>
			</article>
