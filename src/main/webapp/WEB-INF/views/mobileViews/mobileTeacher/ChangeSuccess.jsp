...
<body>
	<div id="section_container">
		<section id="person_section" data-role="section" class="active">
			<header>
				<div class="titlebar">
					<a data-toggle="back" href="javascript:history.go(-1)"><i
			...
			<article data-role="article" id="main_article" data-scroll="verticle"
				...
				<div class="scroller" style="text-align:center">
					<label class="label-center">修改成功。</label><br /> <br /> <br />
					<button onclick="WeixinJSBridge.call('closeWindow');">回到微信</button>
				</div>
			</article>
