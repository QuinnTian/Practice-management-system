...
<body>
	<div id="section_container">
		<section id="TaskDetails01_section" data-role="section" class="active">
			<header>
				<div class="titlebar">
				...
				<div class="scroller">
					<form autocomplete="off"
						...
						<div style="height:auto;" class="label-right">
							<td><input type="hidden" id="question_id" name="question_id"
								value="${knowledge.id}"> ${knowledge.question}</td>
						</div>

						<hr>
						<label class="label-left">提问学生</label>
						<div style="height:auto;" class="label-right">${stuName}</div>
						<hr>
						...
						<div style="height:auto;" class="label-right">
							<output>
								<c:if test="${k.answer_time==null}">
									<font color="red">未解答</font>
								</c:if>
							</output>
						</div>
						<hr>
	...
	<div id="Answer_questions" data-role="modal" class="modal bg-carrot">
		<header>
			<div class="titlebar">
				<a data-toggle="back" href="#"><i
					class="iconfont iconline-arrow-left"></i></a>
		...
		<article data-role="article" id="main_article" data-scroll="verticle"
			...
			<div class="scroller">
				<form id="updateAnswer" 　autocomplete="off"
					...
					<div class="card">
						<textarea rows="5" class="noborder" id="answerer" name="answerer"></textarea>
					</div>
	...
	<script>
		function jump() {
			A.Controller.modal('#Answer_questions');
		}
		(function() {
