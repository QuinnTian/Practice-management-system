		...
		<section id="form_section" data-role="section" class="active">
			<header>
				<div class="titlebar">
					...
					<h1>教师指导记录管理</h1>
					<a id="detail_modal_edit" href="addGuideRecordManagement.do"><i
			...
			<article data-role="article" id="guideRecord" data-scroll="verticle"
				...
				<div class="scroller">
					<ul class="listitem">
						<li class="sliver">教师指导记录管理-${teaName}</li>
					</ul>
					<c:forEach items="${directRecordList}" var="directRecordList"
						varStatus="status">
						<ul class="listitem"
							href="GuideRecordManagement_details.do?id=${directRecordList.id}"
							data-toggle="html">
