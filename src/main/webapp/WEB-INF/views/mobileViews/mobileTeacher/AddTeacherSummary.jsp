			...
			<article data-role="article" id="main_article" data-scroll="verticle"
				...
				<div class="scroller">
					<form autocomplete="off" class="form-square" name="form" id="form"
						method="post" action="doAddTeacherSummary.do">
						<input type="hidden" name="stusId" value="${stusId}" /> <input
							type="hidden" value="${tea.true_name}" id="teaName"
							name="teaName" /> <input type="hidden" id="lastPractice_id"
							value="${lastPractice_id}" /> <label class="label-left"
							style="width:25%">实习任务</label>
						...
						<label class="label-left" style="width:25%">开始时间</label>
