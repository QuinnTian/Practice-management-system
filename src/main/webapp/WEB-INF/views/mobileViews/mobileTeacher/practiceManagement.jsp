 ...
 %>
			...
			<footer>
				<nav class="menubar"
					...
					<div>
						<button class="cancel" id="checknopass">
							<i class="iconfont iconline-rdo-cancel"></i> <span>审批不通过</span>
						</button>
		...
		<article data-role="article" id="modal_article" data-scroll="verticle"
			...
			<div class="scroller">
				...
				<nav class="menubar"
					style="width: 100% ; background-color: #FFFFFF; text-align:center;">
					<div>
						<button class="cancel" id="nopass">
							<i class="iconfont iconline-rdo-cancel"></i> <span>审核不通过</span>
						</button>
						<button id="pass">
							<i class="iconfont iconline-rdo-cancel"></i> <span>审核通过</span>
						</button>
					</div>
				</nav>
			</div>
