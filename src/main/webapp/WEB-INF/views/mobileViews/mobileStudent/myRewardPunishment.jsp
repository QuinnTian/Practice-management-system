	...
	<div id="section_container">
		<section id="form_section" data-role="section" class="active">
			...
			<article data-role="article" id="College_notice"
				...
				<div class="scroller">
					<ul class="listitem">
						<li class="sliver">${stu.group_id}</li>
						<c:forEach items="${evs}" var="ev" varStatus="status">
							<ul class="listitem"
								href="myRewardPunishment_details.do?id=${ev.id}"
								data-toggle="html">
								<li><i class="ricon iconfont iconline-arrow-right"></i>
									<div class="text">
										${stu.true_name}<small>${ev.description}</small>
									</div></li>
							</ul>
						</c:forEach>
					</ul>
		...
		<script
			src="<%=path%>/AgileLite/assets/third/iscroll/iscroll-probe.js"></script>
		<script
