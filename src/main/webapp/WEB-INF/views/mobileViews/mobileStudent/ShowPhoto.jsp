		...
		<section id="aside_section" data-role="section" class="active">
			<header>
				<div class="titlebar">
					...
					<h1>实习照片</h1>
					<a href="UpPhoto.do"><i
						class="iconfont iconline-file-picture
"></i></a>
				</div>
			</header>
				...
				<div class="scroller">
					<ul class="imglist">
						<c:forEach var="s" items="${myPhotos}" varStatus="stauts">
							<li><a data-toggle="section" href=""> <img
									data-source="<%=path%>/uploadedfiles/Photos/${s.file_name}"></img>
									 <span class="midnight-blue pull-left">${s.upload_time}</span>
							</a></li>
						</c:forEach>
					</ul>
				</div>
