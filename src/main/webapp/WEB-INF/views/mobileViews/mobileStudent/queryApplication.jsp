...
<body>
	<div id="section_container">
		<section id="check_section" data-role="section" class="active">
			<header>
				<div class="titlebar">
					<a data-toggle="back" href="#"> <i
						class="iconfont iconline-arrow-left"></i></a>
					<h1>查询申请</h1>
					<a data-toggle="html" href="moreApplication.do">更多申请</a>
				</div>
			</header>
			<article data-role="article" class="active" id="border_article"
				...
				<div class="scroller">
					<form autocomplete="off"
						...
						<hr />
						<label class="label-left" style="width: auto">企业指导教师：</label>
						<div style="height:auto;" class="label-right">
							<output> 王老师 </output>
						</div>
						<hr />
						<label class="label-left" style="width: auto">企业指导教师电话：</label>
						<div class="label-right">
							<output> 12345678900 </output>
						</div>
						<hr />
