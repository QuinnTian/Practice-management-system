...
<body>
	...
	<div class="pd-20">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="member_add('添加用户','<%=path%>/admin/user-add.do','','410')"
	...
	<script type="text/javascript"
		src="H-ui.admin_2.3.1/lib/laypage/1.2/laypage.js"></script>
	<script type="text/javascript"
		src="H-ui.admin_2.3.1/lib/My97DatePicker/WdatePicker.js"></script>
	<script type="text/javascript"
		src="H-ui.admin_2.3.1/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
