...
<link href="H-ui.admin_2.3.1/css/style.css" rel="stylesheet" type="text/css" />
<link href="H-ui.admin_2.3.1/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet"
	type="text/css" />
<!--[if IE 6]>
...
<body>
			...
			<tbody>
				<tr class="text-c">
					...
					<td><a title="编辑" href="javascript:;"
						...
						onclick="admin_permission_del(this,'1')" class="ml-5"
	...
	<script type="text/javascript" src="H-ui.admin_2.3.1/lib/laypage/1.2/laypage.js"></script>
