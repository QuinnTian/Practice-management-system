		...
		<section id="form_section" data-role="section" class="active">
			<header>
				...
				<article data-role="article" id="normal_article" data-scroll="verticle" class="active" style="top:44px;bottom:0px;">
					<div class="scroller">
						<form action="<%=path%>/weixin/bd.do" class="form-common">
							<input type="hidden" value="2" name="type">
							<label class="label-left" for="user">教工号</label>
							<label class="label-right">
								<input id="tea_code" type="text" placeholder="请输入教工号" name="tea_code"  required/>
							</label>
							<hr/>
							<label class="label-left" for="user">姓名</label>
							<label class="label-right">
								<input id="tea_name" type="text" placeholder="请输入您的真实姓名" name="tea_name" required/>
							</label>
							<hr/>
							<label class="label-left" for="user">密码</label>
							<label class="label-right">
								<input id="tea_password" type="text" placeholder="默认是教工号" name="tea_password" required/>
							</label>
							<hr/>
							<br>
