	...
	<div id="section_container">
		<section id="form_section" data-role="section" class="active">
			...
			<article data-role="article" id="normal_article"
				...
				<div class="scroller">
					<form class="form-common" action="<%=path%>/weixin/bd.do">
						<input type="hidden" value="1" name="type">
						<label class="label-left" for="user">学号</label> <label
							class="label-right"> <input id="stu_code" type="text" name="stu_code"
							placeholder="请输入学号"
							required /> </label>
						<hr />
						<label class="label-left" for="user">姓名</label> <label
							class="label-right"> <input id="stu_name" type="text" name="stu_name"
							placeholder="请输入您的真实姓名" 
							 required /> </label>
						<hr />

						<label class="label-left" for="user">身份证号</label> <label
							class="label-right"> <input id="stu_id" type="text" name="stu_id"
							placeholder="请输入身份证号" 
							 required /> </label>
						<hr />
						<label class="label-left" for="user">密码</label> <label
							class="label-right"> <input id="stu_password" type="text" name="stu_password"
							placeholder="默认身份证后六位" 
							 required /> </label>
						<hr />
						<br>
