...
<script type="text/javascript">
	function back() {
		/* history.back();  */
		 window.location.href = "backDiectRecordList.do";  
...
<h2 align="left">教师指导记录</h2>
	...
	<form name="form1" method="post" action="doEditdirectrecord.do">
		...
		<table border="0" width="1000">
			...
			<tr>
				<td width="50">标题：</td>
				<td width="300">${directrecord.title}
				</td>
			</tr>
			<tr>
				<td width="50">开始时间：</td>
			...
			<tr>
				<td width="50">结束时间：</td>
				<td width="300">
					<fmt:parseDate value="${directrecord.temp2}" var="temp2" />
					<fmt:formatDate value="${temp2}" pattern="yyyy/MM/dd" />
				</td>
			</tr>
			<tr>
				<td width="50">指导地点：</td>
				<td width="300">${directrecord.direct_place}
				</td>
			</tr>
				<tr>
			<td width="50">文件描述：</td>
