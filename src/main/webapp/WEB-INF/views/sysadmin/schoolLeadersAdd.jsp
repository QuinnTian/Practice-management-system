...
<script type="text/javascript">
	function doAdd() {
		...
		if(phontLength < 7 || phontLength > 12){
			...
			"&phone="+phone+"&dept_id="+dept_id+"&duties="+duties;
			location.href="doSchoolLeadersAdd.do?"+datasend;
	  };
	}
</script>
</head>
		...
		<table border="0" width="1000">
			<tr>
				...
				<td width="700"><input type="text" name="tea_code"
					id="tea_code" required="required" />
				</td>
			</tr>
			<tr>
				<td width="150">姓名：</td>
				<td width="700"><input type="text" name="tea_name"
					id="tea_name" required="required" />
				</td>
			</tr>
			<tr>
				<td width="150">性别：</td>
				<td width="700"><select name="sex" id="sex">
			...
			<tr>
				...
				<td width="700"><select name="dept_id" id="dept_id">
			...
			<tr>
				<td width="150">职务：</td>
				<td width="700"><input type="text" name="duties" id="duties"
					required="required" />
				</td>
			</tr>
		</table>
