...
sEmptyTable:"没有数据可显示",sInfo:"显示 _START_ 到 _END_ 条数据 共 _TOTAL_ 条数据",sInfoEmpty:"显示 0 到 0 从 0 行",sInfoFiltered:"(总共 _MAX_ 条数据)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"每页显示 _MENU_ 条数据",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"根据关键字搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有找到匹配项"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,
