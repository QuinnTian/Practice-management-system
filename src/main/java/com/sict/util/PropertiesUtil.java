...
public class PropertiesUtil {
	...
	private static void loadFile(String filename) {
		try {
			// System.out.println("--------zxg:begin");
			properties.load(PropertiesUtil.class.getResourceAsStream("/config/"
					+ filename));
			// System.out.println("--------zxg:success");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		PropertiesUtil propertiesUtil = PropertiesUtil
				.createPropertiesUtil("upload.properties");
